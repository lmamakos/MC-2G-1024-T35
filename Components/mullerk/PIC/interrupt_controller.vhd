...
-- Simple Z80 interrupt controller
...
-- The int_out lines are suitable for plumbing straight into Z80 or similar.
-- Interrupts are prioritised, highest number first, and asserted until acknowledged with the
-- ack signal (HIGH puls).
-- Higher interrupts can absurb lower interrupts
